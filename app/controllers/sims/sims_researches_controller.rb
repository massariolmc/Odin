class Sims::SimsResearchesController < ApplicationController
  ...
  def index    
      if params[:datai].present? && params[:dataf].present?
        verifica_dados(params[:pessoa], params[:esq], params[:area_acesso], params[:mov], params[:sel], params[:busca], 
  ...
  private
    ...
    def verifica_dados(pessoa,esq,area_acesso,mov,sel,busca,datai,dataf,horai,horaf,cracha)
      ...
      case area_acesso
        when '1'
          aa = " and portao_tipo=#{area_acesso}"
        when '2'
          aa = " and portao_tipo=#{area_acesso}"
        when '3'
          aa = " and portao_tipo=#{area_acesso}"  
